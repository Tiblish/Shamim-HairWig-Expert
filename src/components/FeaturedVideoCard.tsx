...
export default function FeaturedVideoCard({
  ...
  return (
    <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-150 p-6 sm:p-8 flex flex-col justify-between h-full">
      ...
      <div className="space-y-3 mb-6">
        ...
        <p className="text-gray-500 text-xs sm:text-sm leading-relaxed font-inter">
          {desc}
        </p>
      </div>

      {/* Embed Iframe Container */}
      <div className="relative aspect-video rounded-2xl overflow-hidden shadow-inner border border-gray-200 bg-gray-100">
        <iframe
          src={embedUrl}
          title={title}
